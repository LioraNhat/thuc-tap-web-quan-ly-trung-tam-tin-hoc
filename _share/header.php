...
<body>
        ...
        <header class="blog-header bg-dark py-1">
                <div class="d-flex justify-content-between align-items-center">
                    <a class="text-white ml-2" href="http://localhost/AP-NextTechAcademy-main/login.php"> Đăng nhập</a>
                <div>
            ...
            <nav class="navbar navbar-expand-sm shadow-sm bg-white sticky-top">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    ...
                    <li class="nav-item active hover-a">
                            <a class="nav-link text-muted  mx-1 hover-a" href="http://localhost/AP-NextTechAcademy-main/index.php">Trang chủ</a>
                        </li>
                        <li class="nav-item">
