...
// $times = getSimpleQuery($listTimeQuery,true); Code cũ

// Code mới
$listTimeQuery = "SELECT t.*, cl.name as class_name, r.name as room_name, 
                         tea.fullname as teacher_name, s.name as session_name, s.time as session_time
                  FROM timetable t
...
?> 
        <div class="container-fluid py-2">
             ...
             <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="http://localhost/AP-NextTechAcademy-main/index.php">Home</a></li>
         ...
         <div class="container-fluid pb-4">
             <div class="container">
                ...
                <tr>
                    ...
                    <td><?= $row['class_name'] ?? 'Chưa xác định' ?></td>
                    <td><?= $row['room_name'] ?? 'Chưa xác định' ?></td>
                    <td><?= $row['teacher_name'] ?? 'Chưa xác định' ?></td>
                    <td><?= ($row['session_name'] && $row['session_time']) ? $row['session_name'].' ('.$row['session_time'].')' : 'N/A' ?></td>
                </tr>
                <!-- Code mới -->
                <?php } ?>
              </tbody>
