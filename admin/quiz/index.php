<?php 
    ...
    // Code mới
    $listRoomQuery = "select q.*, c.name as course_name, 
                    (select count(*) from question where quiz_id = q.id) as total 
                  from quiz q 
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php 
                    ...
                    // Kiểm tra nếu có tên khóa học thì hiển thị, không thì báo chưa gán
                    //Code mới
                    echo !empty($row['course_name']) ? $row['course_name'] : '<span class="label label-default">Chưa gán khóa học</span>';
                    //Code mới
                  ?></td>
                  <?php if($_SESSION['login']['role']== 500){ ?>
